"""
Django settings for atlas_security_41349 project.
...
ROOT_URLCONF = 'atlas_security_41349.urls'
...
WSGI_APPLICATION = 'atlas_security_41349.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "atlas_security_41349 API",
    "DESCRIPTION": "API documentation for atlas_security_41349 App",
    "VERSION": "v1",
}
